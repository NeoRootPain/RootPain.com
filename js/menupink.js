let LeftMenuContent = `
		...
		<div class="navigationbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/navigationbarpink.png?raw=true');"></div>
		...
		<div class="handlebarside" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/handlebarsidepink.png?raw=true');"></div>
		</div>

		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/affiliatesbarpink.png?raw=true');"></div>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/socialsbarpink.png?raw=true');"></div>

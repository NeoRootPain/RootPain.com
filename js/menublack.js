let LeftMenuContent = `
		...
		<div class="navigationbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/navigationbarblack.png?raw=true');"></div>
		...
		<div class="handlebarside" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/handlebarsideblack.png?raw=true');"></div>
		</div>

		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/affiliatesbarblack.png?raw=true');"></div>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/socialsbarblack.png?raw=true');"></div>

let LeftMenuContent = `
		...
		<div class="navigationbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/navigationbarblue.png?raw=true');"></div>
		...
		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/affiliatesbarblue.png?raw=true');"></div>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/socialsbarblue.png?raw=true');"></div>

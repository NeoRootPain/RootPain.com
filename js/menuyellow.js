let LeftMenuContent = `
		...
		<div class="navigationbar" style="background-image:url('images/sidemenus/navigationbaryellow.png');"></div>
		<a href="index.html">
		...
		<div class="handlebarside" style="background-image:url('images/sidemenus/handlebarsideyellow.png');"></div>
		</div>

		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('images/sidemenus/affiliatesbaryellow.png');"></div>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('images/sidemenus/socialsbaryellow.png');"></div>

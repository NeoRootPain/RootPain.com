let LeftMenuContent = `
		...
		<div class="handlebarside" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/handlebarsideyellow.png?raw=true');"></div>
		</div>

		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/affiliatesbaryellow.png?raw=true');"></div>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/socialsbaryellow.png?raw=true');"></div>

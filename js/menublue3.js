let LeftMenuContent = `
		...
		<div class="navigationbar" style="background-image:url('../../../images/sidemenus/navigationbarblue.png');"></div>
		<a href="../../../index.html">
		...
		<div class="handlebarside" style="background-image:url('../../../images/sidemenus/handlebarsideblue.png');"></div>
		</div>

		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('../../../images/sidemenus/affiliatesbarblue.png');"></div>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('../../../images/sidemenus/socialsbarblue.png');"></div>

let LeftMenuContent = `
		...
		<div class="navigationbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/navigationbargreen.png?raw=true');"></div>

		<a href="https://rootpain.com/index.html">
			<img src="https://github.com/JuneSSai/RootPain.com/blob/main/images/buttons/navbarhomebutton.png?raw=true" class="button"></a>
		...
		<div class="handlebarside" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/handlebarsidegreen.png?raw=true');"></div>
		</div>

		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/affiliatesbargreen.png?raw=true');"></div>
		<a href="https://gameslime.com/" target="_blank">
			<img src="https://github.com/JuneSSai/RootPain.com/blob/main/images/buttons/gameslimebutton.png?raw=true" class="button"></a>
		<a href="https://sagerankov.com/" target="_blank">
			<img src="https://github.com/JuneSSai/RootPain.com/blob/main/images/buttons/staggernightbutton.png?raw=true" class="button"></a>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('https://github.com/JuneSSai/RootPain.com/blob/main/images/sidemenus/socialsbargreen.png?raw=true');"></div>
			<a href="https://junessai.newgrounds.com/">
				<img src="https://github.com/JuneSSai/RootPain.com/blob/main/images/buttons/newgroundsbutton.png?raw=true" class="button"></a>

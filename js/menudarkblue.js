let LeftMenuContent = `
		...
		<div class="navigationbar" style="background-image:url('images/sidemenus/navigationbardarkblue.png');"></div>
		<a href="index.html">
		...
		<div class="handlebarside" style="background-image:url('images/sidemenus/handlebarsidedarkblue.png');"></div>
		</div>

		<div class="affbarcontainer">
			<div class="affiliatesbar" style="background-image:url('images/sidemenus/affiliatesbardarkblue.png');"></div>
		...
		<div class="socialsbarcontainer">
			<div class="socialsbar" style="background-image:url('images/sidemenus/socialsbardarkblue.png');"></div>
